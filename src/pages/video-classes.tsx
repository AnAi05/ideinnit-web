...
//         <div className="relative px-4 sm:px-6 lg:px-8">
//           <div className="text-lg max-w-prose mx-auto mb-6">
//             <p className="text-base text-center leading-6 text-gray-600 font-semibold tracking-wide uppercase">Course Info</p>
...
//             <br />
//             <span className="text-gray-600">Join CPI Classes today!</span>
//           </h2>
//           <div className="mt-8 flex lg:flex-shrink-0 lg:mt-0">
//             <div className="inline-flex rounded-md shadow">
//               <a href="https://forms.gle/ZnxAefowRcXoaCgx7" target="_blank" className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-gray-600 hover:bg-gray-500 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
//                 Apply Now
//               </a>
//             </div>
//             <div className="ml-3 inline-flex rounded-md shadow">
//               <a href="mailto:lajatm9@gmail.com" target="_blank" className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-gray-600 bg-white hover:text-gray-500 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out">
//                 Contact Us
//               </a>
//             </div>
//           </div>
